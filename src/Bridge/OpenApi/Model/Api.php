...
class Api implements Contract\Api
{
    ...
    public function __construct(private readonly string $title, private readonly string $version, private readonly string $description, private readonly ?string $email = null) {}
